...
export const blogPosts: BlogPost[] = [
  {
    ...
    description: 'TikTok isn\'t just for entertainment. Discover how short-form video content can accelerate your language learning with the right approach and tools.',
    date: '2025-01-15',
    readTime: '6 min read',
...
TikTok and short-form video aren't distractions from language learning — they're one of the most effective tools available. With the right approach, every scroll through your feed becomes a micro-lesson in your target language.
  ...
  },
  {
    ...
    description: 'Learn how the SM-2 algorithm and spaced repetition systems can help you remember vocabulary permanently, not just for the next quiz.',
    date: '2025-01-08',
    readTime: '5 min read',
    category: 'Science',
    content: `
...
Retell automatically creates SRS flashcards from every lesson, complete with audio pronunciation, example sentences, and the original video context. This means every video you learn from automatically feeds your long-term vocabulary system.
  ...
  },
  {
    ...
    description: 'Stop sounding like a textbook. These evidence-based pronunciation techniques will help you sound more natural in any language.',
    date: '2024-12-20',
    readTime: '7 min read',
    category: 'Speaking',
    content: `
