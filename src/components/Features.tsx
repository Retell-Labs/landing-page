    ...
    <section ref={sectionRef} id="features" className="py-16 md:py-24 px-3 md:px-5">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
          {/* Card A — Phone Preview (tall, gold) */}
          <div
            className={`${cardBase} bg-retell-gold text-retell-navy flex flex-col items-center justify-center ${cardHover} order-3 md:order-1 lg:row-span-2 p-6 ${animClass('animation-delay-100')}`}
          >
            <p className="text-xs font-semibold text-retell-navy/50 tracking-widest uppercase mb-4">
              See it in action
            </p>
          ...
          {/* Card B — Import Any Video (violet) */}
          <div
            className={`${cardBase} bg-retell-violet text-white ${cardHover} order-1 md:order-2 ${animClass('animation-delay-200')}`}
          >
            ...
            <h3 className="text-xl font-bold">Import Any Video</h3>
          ...
          {/* Card C — AI-Powered Lessons (navy dark) */}
          <div
            className={`${cardBase} bg-retell-navy text-white hover:shadow-elevated hover:-translate-y-1 order-2 md:order-3 ${animClass('animation-delay-300')}`}
          >
            <div className="w-12 h-12 bg-retell-gold rounded-2xl flex items-center justify-center mb-5">
              <svg
                width="24"
                height="24"
                viewBox="0 0 24 24"
            ...
            <h3 className="text-xl font-bold">AI-Powered Lessons</h3>
          ...
          {/* Card D — Practice Speaking (pink) */}
          <div
            className={`${cardBase} bg-retell-pink text-white ${cardHover} order-4 ${animClass('animation-delay-400')}`}
          >
            <div className="w-12 h-12 bg-white/20 rounded-2xl flex items-center justify-center mb-5">
              <svg
                width="24"
          ...
          {/* Card E — How It Works (sky blue) */}
          <div
            className={`${cardBase} bg-retell-sky text-white ${cardHover} order-5 ${animClass('animation-delay-500')}`}
          >
            ...
            <div className="flex flex-col gap-4">
              {[
                ...
                <div key={item.step} className="flex items-center gap-4">
                  <div className="w-9 h-9 bg-white text-retell-sky rounded-full flex items-center justify-center font-bold text-sm shrink-0">
                    {item.step}
                  </div>
          ...
          {/* Card F — Stats (full width, lime) */}
          <div
            className={`${cardBase} bg-retell-lime text-retell-navy md:col-span-2 lg:col-span-3 hover:shadow-card order-6 ${animClass('animation-delay-600')}`}
          >
